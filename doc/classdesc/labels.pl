...
$key = q/CLASSDESC_ACCESS/;
$external_labels{$key} = "$URL/" . q|node8.html|; 
$noresave{$key} = "$nosave";

$key = q/classdesc_epilogue/;
...
$key = q/is_associative_container/;
$external_labels{$key} = "$URL/" . q|node10.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_daniels00:_swarm_com/;
...
$key = q/cite_johnson:_swarm_user_guide/;
$external_labels{$key} = "$URL/" . q|node48.html|; 
$noresave{$key} = "$nosave";

$key = q/polymorph-example/;
$external_labels{$key} = "$URL/" . q|node18.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_kernighan88:_c/;
$external_labels{$key} = "$URL/" . q|node48.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_Madina-Standish01/;
$external_labels{$key} = "$URL/" . q|node48.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_larkin93:_objec_orien_progr_objec_c/;
$external_labels{$key} = "$URL/" . q|node48.html|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_02:_insid_mac_os_x/;
$external_labels{$key} = "$URL/" . q|node48.html|; 
$noresave{$key} = "$nosave";

$key = q/cite_98:_objec_c_languag_rhaps_devel_docum/;
$external_labels{$key} = "$URL/" . q|node48.html|; 
$noresave{$key} = "$nosave";
...
$key = q/sec2.6/;
$external_latex_labels{$key} = q|10.2.6|; 
$noresave{$key} = "$nosave";
